			...
			<div className='w-full mx-auto text-center md:w-1/2 md:text-left lg:p-20'>
				<RoughNotationGroup show={true}>
					<RainbowHighlight color={colors[0]}>
						<h1 className='my-2 text-4xl font-bold text-gray-700 md:text-8xl dark:text-gray-200'>Developer.</h1>
					</RainbowHighlight>
					<RainbowHighlight color={colors[1]}>
						<h1 className='my-2 text-4xl font-bold text-gray-700 md:text-8xl dark:text-gray-200'>Learner.</h1>
					</RainbowHighlight>
					<RainbowHighlight color={colors[2]}>
						<h1 className='my-2 text-4xl font-bold text-gray-700 md:text-8xl dark:text-gray-200'>Leader.</h1>
					</RainbowHighlight>
				</RoughNotationGroup>
			</div>
			{/* Image container */}
